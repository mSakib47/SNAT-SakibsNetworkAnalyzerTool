...
def amountOfProtocols():
    ...
    if selectedFilename:
        try:
            ...
            start_end_points = simpledialog.askstring("Packet Analysis", "Enter the starting and ending points for packet analysis (e.g., start-end):")
...
canvas.create_window(400, 100, anchor="nw", window=exitButton)
